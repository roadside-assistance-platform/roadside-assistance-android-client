...
object RedColors {
    ...
    private val onPrimaryContainerLight = Color(0xFF3A0905)
    ...
    private val onTertiaryContainerLight = Color(0xFF251A00)
    ...
    private val primaryLightMediumContrast = Color(0xFF6E3027)
    private val onPrimaryLightMediumContrast = Color(0xFFFFFFFF)
    private val primaryContainerLightMediumContrast = Color(0xFFAA6054)
    private val onPrimaryContainerLightMediumContrast = Color(0xFFFFFFFF)
    private val secondaryLightMediumContrast = Color(0xFF593B37)
    private val onSecondaryLightMediumContrast = Color(0xFFFFFFFF)
    private val secondaryContainerLightMediumContrast = Color(0xFF8F6C67)
    private val onSecondaryContainerLightMediumContrast = Color(0xFFFFFFFF)
    private val tertiaryLightMediumContrast = Color(0xFF524015)
    private val onTertiaryLightMediumContrast = Color(0xFFFFFFFF)
    private val tertiaryContainerLightMediumContrast = Color(0xFF877242)
    ...
    private val outlineVariantLightMediumContrast = Color(0xFF897774)
    ...
    private val inversePrimaryLightMediumContrast = Color(0xFFFFB4A8)
    ...
    private val surfaceContainerHighLightMediumContrast = Color(0xFFF7E4E1)
    private val surfaceContainerHighestLightMediumContrast = Color(0xFFF1DFDC)

    private val primaryLightHighContrast = Color(0xFF44100A)
    private val onPrimaryLightHighContrast = Color(0xFFFFFFFF)
    private val primaryContainerLightHighContrast = Color(0xFF6E3027)
    private val onPrimaryContainerLightHighContrast = Color(0xFFFFFFFF)
    private val secondaryLightHighContrast = Color(0xFF341C18)
    private val onSecondaryLightHighContrast = Color(0xFFFFFFFF)
    private val secondaryContainerLightHighContrast = Color(0xFF593B37)
    private val onSecondaryContainerLightHighContrast = Color(0xFFFFFFFF)
    private val tertiaryLightHighContrast = Color(0xFF2D2000)
    private val onTertiaryLightHighContrast = Color(0xFFFFFFFF)
    private val tertiaryContainerLightHighContrast = Color(0xFF524015)
    ...
    private val surfaceContainerHighLightHighContrast = Color(0xFFF7E4E1)
    private val surfaceContainerHighestLightHighContrast = Color(0xFFF1DFDC)
    ...
    private val primaryDarkMediumContrast = Color(0xFFFFBAAF)
    private val onPrimaryDarkMediumContrast = Color(0xFF330502)
    private val primaryContainerDarkMediumContrast = Color(0xFFCC7B6F)
    private val onPrimaryContainerDarkMediumContrast = Color(0xFF000000)
    private val secondaryDarkMediumContrast = Color(0xFFECC1BA)
    private val onSecondaryDarkMediumContrast = Color(0xFF26100D)
    private val secondaryContainerDarkMediumContrast = Color(0xFFAE8882)
    private val onSecondaryContainerDarkMediumContrast = Color(0xFF000000)
    private val tertiaryDarkMediumContrast = Color(0xFFE2C890)
    private val onTertiaryDarkMediumContrast = Color(0xFF1F1500)
    private val tertiaryContainerDarkMediumContrast = Color(0xFFA58E5B)
    ...
    private val onBackgroundDarkMediumContrast = Color(0xFFF1DFDC)
    ...
    private val onSurfaceVariantDarkMediumContrast = Color(0xFFDCC6C2)
    private val outlineDarkMediumContrast = Color(0xFFB39E9B)
    private val outlineVariantDarkMediumContrast = Color(0xFF927F7C)
    private val scrimDarkMediumContrast = Color(0xFF000000)
    private val inverseSurfaceDarkMediumContrast = Color(0xFFF1DFDC)
    private val inverseOnSurfaceDarkMediumContrast = Color(0xFF322826)
    private val inversePrimaryDarkMediumContrast = Color(0xFF74352C)
    ...
    private val primaryContainerDarkHighContrast = Color(0xFFFFBAAF)
    ...
    private val secondaryContainerDarkHighContrast = Color(0xFFECC1BA)
    ...
    private val tertiaryContainerDarkHighContrast = Color(0xFFE2C890)
    ...
    private val onBackgroundDarkHighContrast = Color(0xFFF1DFDC)
    ...
    private val outlineDarkHighContrast = Color(0xFFDCC6C2)
    private val outlineVariantDarkHighContrast = Color(0xFFDCC6C2)
    private val scrimDarkHighContrast = Color(0xFF000000)
    private val inverseSurfaceDarkHighContrast = Color(0xFFF1DFDC)
    private val inverseOnSurfaceDarkHighContrast = Color(0xFF000000)
    private val inversePrimaryDarkHighContrast = Color(0xFF4E1811)
